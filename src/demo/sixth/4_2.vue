...
let gl, a_Position, canvas, a_Color, a_Normal, program, u_MvpMatrix, u_ModelMatrix, u_NormalMatrix, u_LightColor, u_LightPosition, u_AmbientColor, indices, rotateMatrix, animationId
...
const initGl = () => {
  ...
  const baseMvpMatrix = new Matrix4()
  baseMvpMatrix
